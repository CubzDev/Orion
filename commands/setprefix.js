...
exports.run = (client, message, args) => {
    ...
    if(!message.member.hasPermission(client.adminPermission)) return message.channel.send(client.noPermission);
    ...
    if(args[0].length > 3) return message.channel.send("A prefix can only be 3 characters");
